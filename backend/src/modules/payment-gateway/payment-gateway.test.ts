...
describe('Payment Gateway Adapter (T4.2)', () => {
  ...
  describe('Factory createPaymentGatewayAdapter', () => {
    ...
    it('throw untuk provider belum diimplementasi (midtrans)', () => {
      expect(() => createPaymentGatewayAdapter('midtrans', {
        environment: 'sandbox',
        merchantId: 'test',
        apiKey: 'test',
    ...
    it('throw untuk provider belum diimplementasi (xendit)', () => {
      expect(() => createPaymentGatewayAdapter('xendit', {
        environment: 'sandbox',
        merchantId: 'test',
        apiKey: 'test',
    ...
    it('throw untuk provider unknown', () => {
      expect(() => createPaymentGatewayAdapter('unknown' as 'midtrans' | 'xendit' | 'mock', {
        environment: 'sandbox',
        merchantId: 'test',
        apiKey: 'test',
