...
describe('PDDikti Sync Adapter (T4.3)', () => {
  ...
  describe('MockPddiktiAdapter', () => {
    ...
    describe('syncMahasiswa - idempotent upsert', () => {
      it('create baru untuk NIM yang belum ada', async () => {
        ...
        const newMhs = [
          { nim: 'MHS999', nama: 'Baru Mahasiswa', prodiKode: 'TI', angkatan: 2024, status: 'aktif' as const },
        ];
      ...
      it('update existing untuk NIM yang sudah ada', async () => {
        ...
        const updateMhs = [
          { nim: 'MHS001', nama: 'Budi Santoso Updated', prodiKode: 'TI', angkatan: 2023, status: 'aktif' as const },
        ];
      ...
      it('multiple sync same data = idempotent (created=0, updated=0 on second run)', async () => {
        ...
        const data = [
          { nim: 'MHS888', nama: 'Idempotent Test', prodiKode: 'TI', angkatan: 2024, status: 'aktif' as const },
        ];
      ...
      it('sync mixed new + existing', async () => {
        ...
        const mixed = [
          { nim: 'MHS001', nama: 'Budi Updated', prodiKode: 'TI', angkatan: 2023, status: 'aktif' as const }, // existing
          { nim: 'MHS999', nama: 'Baru', prodiKode: 'TI', angkatan: 2024, status: 'aktif' as const }, // new
        ];
    ...
    describe('syncDosen - idempotent upsert by NIDN', () => {
      it('create baru untuk NIDN yang belum ada', async () => {
        ...
        const newDosen = [
          { nidn: '9999999999', nama: 'Dosen Baru', prodiKode: 'TI', jenisKelamin: 'L' as const, statusKepengurusan: 'tetap' as const },
        ];
      ...
      it('update existing untuk NIDN yang sudah ada', async () => {
        ...
        const updateDosen = [
          { nidn: '0012345601', nama: 'Dr. Andi Updated', prodiKode: 'TI', jenisKelamin: 'L' as const, statusKepengurusan: 'tetap' as const },
        ];
    ...
    describe('syncNilai - idempotent upsert by composite key (nim + kodeMk + semester)', () => {
      it('create baru untuk kombinasi yang belum ada', async () => {
        ...
        const newNilai = [
          { nim: 'MHS001', kodeMk: 'IF999', semester: '20241', nilaiAngka: 90, nilaiHuruf: 'A', bobot: 4.00 },
        ];
      ...
      it('update existing untuk kombinasi yang sudah ada', async () => {
        ...
        const updateNilai = [
          { nim: 'MHS001', kodeMk: 'IF101', semester: '20241', nilaiAngka: 95, nilaiHuruf: 'A', bobot: 4.00 },
        ];
  ...
  describe('Factory createPddiktiSyncAdapter', () => {
    ...
    it('throw untuk provider real belum diimplementasi', () => {
      expect(() => createPddiktiSyncAdapter('pddikti', {
        baseUrl: 'https://test',
        username: 'test',
        password: 'test',
    ...
    it('throw untuk provider unknown', () => {
      expect(() => createPddiktiSyncAdapter('unknown' as 'mock' | 'pddikti', {
        baseUrl: 'https://test',
        username: 'test',
        password: 'test',
  ...
  describe('Error handling', () => {
    it('syncMahasiswa menangkap error per item', async () => {
      ...
      const result = await adapter.syncMahasiswa([
        { nim: 'ERROR_TEST', nama: 'Test', prodiKode: 'TI', angkatan: 2024, status: 'aktif' as const },
      ]);
