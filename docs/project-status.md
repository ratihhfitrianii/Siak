...
|---------|------|-------|----------|--------|
| **Iterasi 1 — MVP Core** | T1.1–T1.15 | Fondasi, Auth/RBAC, KRS flow, nilai dasar, import, audit, waiting room MVP, load test, staging | ~39 hari kerja | 🟢 **T1.1–T1.10 selesai**; 🟢 **T1.11 TUNTAS** (11a `91ecf05`, 11b `6233e37`, 11c `8c3f2c4`, 11d polish; commit 11d manual menunggu) |
