...
|---------|------|-------|----------|--------|
| **Iterasi 1 — MVP Core** | T1.1–T1.15 | Fondasi, Auth/RBAC, KRS flow, nilai dasar, import, audit, waiting room MVP, load test, staging | ~39 hari kerja | 🟡 **T1.1 selesai & reviewed** (2026-08-01, CONDITIONALLY APPROVED); T1.2–T1.15 siap start (butuh repo git) |
