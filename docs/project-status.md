...
|---------|------|-------|----------|--------|
| **Iterasi 1 — MVP Core** | T1.1–T1.15 | Fondasi, Auth/RBAC, KRS flow, nilai dasar, import, audit, waiting room MVP, load test, staging | ~39 hari kerja | 🟢 **T1.1–T1.10 selesai & tervalidasi**; 🔵 **T1.11a frontend fondasi berjalan** (login + ganti password; commit manual owner menunggu) |
