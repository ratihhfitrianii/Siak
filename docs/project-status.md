...
|---------|------|-------|----------|--------|
| **Iterasi 1 — MVP Core** | T1.1–T1.15 | Fondasi, Auth/RBAC, KRS flow, nilai dasar, import, audit, waiting room MVP, load test, staging | ~39 hari kerja | 🟢 **T1.1–T1.10 selesai & tervalidasi** (T1.7/T1.8 di-commit: 2962759, 989e89e; T1.9+T1.10 menunggu commit owner) |
