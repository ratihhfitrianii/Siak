...
|---------|------|-------|----------|--------|
| **Iterasi 1 — MVP Core** | T1.1–T1.15 | Fondasi, Auth/RBAC, KRS flow, nilai dasar, import, audit, waiting room MVP, load test, staging | ~39 hari kerja | 🟢 **T1.1–T1.10 selesai**; 🟢 **T1.11a fondasi frontend** (commit 91ecf05); 🔵 **T1.11b dashboard mahasiswa** (KRS+transkrip; commit manual menunggu) |
