    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Daftar tagihan mahasiswa per semester</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {loading && <div className="h-4 bg-gray-100 animate-pulse" />}
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              {payments.map((payment) => (
                <tr key={payment.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">{payment.fullName}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{payment.prodiName}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{payment.semesterName}</td>
